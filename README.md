...
4. Download the `MCLauncher-11.0-alpha21-arm64-v8a` artifact.
5. Extract it and install `MCLauncher-11.0-alpha21-arm64-v8a.apk`.
...
download the artifact containing `alpha21-microsoft`. Because this APK has a
