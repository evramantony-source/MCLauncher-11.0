...
Use a clean MCLauncher 11.0 Alpha 02 installation.

1. Install the GitHub Actions `MCLauncher-11.0-alpha02-arm64-v8a.apk`.
...
7. Navigate every main-menu button with the virtual cursor, including left and right clicks.
...
12. If launch or input fails, export `latest-session.log` before changing settings.
